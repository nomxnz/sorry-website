    ...
    extend: {
      ...
      keyframes: {
        ...
        fall: {
          ...
          to: { transform: "translateY(110%)", opacity: "0.1" },
        },
        twinkle: {
          "0%, 100%": { opacity: "0.25" },
          "50%": { opacity: "1" },
        ...
        glow: {
          from: { filter: "drop-shadow(0 0 0 rgba(255, 105, 180, 0))" },
          to: { filter: "drop-shadow(0 0 12px rgba(255, 105, 180, 0.65))" },
        },
        pop: {
